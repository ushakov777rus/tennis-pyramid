...
export const metadata: Metadata = {
  ...
  description:
    "Турнирная платформа для тенниса, падела, пиклбола и бадминтона: генератор турнирной сетки онлайн (бесплатно), организация турниров, результаты, рейтинги, статистика и история матчей.",
  keywords: [
    ...
    "составление турнирной таблицы онлайн",
